...
import VeichleScrapPage from "./pages/VeichleScraping/VehicleScrapPage"
import ZeroWasteSocietyPage from "./pages/ZeroWasteSocietyPage/ZeroWasteSocietyPage";
import SellEWastePage from "./pages/SellEWastePage/SellEWastePage";
  ...
  return (
    <Fragment>
      ...
      <Routes>
        ...
        <Route path="/vehicle-scrap" element={
          <CheckAuth isAuthenticate={isAuthenticate} user={user}>
            <VeichleScrapPage/>
          </CheckAuth>
        }>
        ...
        <Route path="/zero-waste" element={
          <CheckAuth isAuthenticate={isAuthenticate} user={user}>
            <ZeroWasteSocietyPage/>
          </CheckAuth>
        }>
        </Route>

        <Route path="/e-waste" element={
          <CheckAuth isAuthenticate={isAuthenticate} user={user}>
            <SellEWastePage/>
          </CheckAuth>
        }>
