        ...
        <div className="flex flex-col justify-center items-center gap-10 py-6">
            <div>
                ...
                <p className="text-xl pt-5">
                    It's your first time then, <Link to={'/auth/signup-user'} className="text-blue-500 underline ">Sign Up</Link>
                </p>
            </div>
            <div>
                <CommonForm formControls={userLoginForm} formData={formData} setFormData={setFormData} buttonText={'Sign In'} onSubmit={handleOnUserLogin} />
            ...
            <div className="w-[30%] flex justify-end">
                <Link to={"/auth/forgotpassword-user"} state={{ role: 'consumer' }} className="text-blue-500 text-xl font-semibold hover:text-blue-700 underline">
                    Forgot Password?
                </Link>
            </div>
        </div>
